...
public interface SearchTicketMapper {
    @Select("select t.trainId,t.trainNum,t.startTime,t.startStationName,t.endTime,sa.travelTime as travelTime,t.endStationName,COALESCE(sa.A,0) as A,\n" +
            "COALESCE(sb.B,0) as B,COALESCE(sc.C,0) as C from train t \n" +
            "  LEFT JOIN\n" +
            "   (Select trainId,count(seatId) as A ,travelTime from ticketseat \n" +
            ...
            "where t.startStationName=#{start} and t.endStationName=#{end}")
